...
jsPsych.plugins['free-sort'] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    for (var i = 0; i < trial.stimuli.length; i++) {
      ...
      var xcoord = trial.sort_area_width - (trial.stim_width * (i%num_cols));
      var ycoord = trial.sort_area_height - (trial.stim_height * (i%num_rows));
      ...
      display_element.querySelector("#jspsych-free-sort-arena").innerHTML += '<img '+
        ...
        'draggable="false" '+
        'style="position: absolute; cursor: move; width:'+trial.stim_width+'px; height:'+trial.stim_height+'px; top:'+coords.y+'px; left:'+coords.x+'px; border:0px solid #444;">'+
        '</img>';
